<x-guest-layout>
    ...
    <p class="text-sm text-gray-500 mb-6">Bắt đầu miễn phí</p>
    ...
    @if (config('common.auth_driver') === 'google')
        ...
        <p class="mt-4 text-center text-sm text-gray-500">
            Đã có tài khoản?
            <a href="{{ route('login') }}" class="text-primary-600 hover:underline font-medium">Đăng nhập</a>
        </p>
    ...
    @else
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            @csrf
            <div>
                <label for="name" class="block mb-1.5 text-sm font-medium text-gray-700">Họ và tên</label>
